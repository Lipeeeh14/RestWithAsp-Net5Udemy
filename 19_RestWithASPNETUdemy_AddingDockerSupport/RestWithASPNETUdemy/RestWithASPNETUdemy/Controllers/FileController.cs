...
namespace RestWithASPNETUdemy.Controllers
{
    ...
    public class FileController : Controller
    {
        ...
        [ProducesResponseType((200), Type = typeof(byte[]))] // caso de sucesso
        ...
        [HttpPost("uploadFile")]
        [ProducesResponseType((200), Type = typeof (FileDetailVO))] // caso de sucesso
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        ...
        [ProducesResponseType((200), Type = typeof (List<FileDetailVO>))] // caso de sucesso
        [ProducesResponseType(400)]
        [ProducesResponseType(401)]
        [Produces("application/json")]
